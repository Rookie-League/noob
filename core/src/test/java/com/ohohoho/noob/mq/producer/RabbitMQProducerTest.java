...
@ComponentScan(basePackages = {"com.ohohoho.noob.mq.producer", "com.ohohoho.noob.mq.message"})
@ContextConfiguration(classes = {RabbitMQConfig.class}, loader = AnnotationConfigContextLoader.class)
